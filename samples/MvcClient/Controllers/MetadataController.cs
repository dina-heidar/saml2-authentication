...
//    {
//        private readonly ILogger<BasicSpMetadataController> _logger;
//        private readonly IMediator _mediator;

//        public BasicSpMetadataController(ILogger<BasicSpMetadataController> logger, IMediator mediator)
//        {
//            _logger = logger;
//            _mediator = mediator;
//        }
...
//                {
//                    EncryptionCertificate = new X509Certificate2("C://Users/dinah/Desktop/IdentityAPI.doc.la.gov.pfx", "HondaS2000", X509KeyStorageFlags.Exportable),
...
//                    //}
//                },
//                SigningCertificate = new X509Certificate2("C://Users/dinah/Desktop/IdentityAPI.doc.la.gov.pfx", "HondaS2000", X509KeyStorageFlags.Exportable),
//                EntityID = "identityAPI.doc.la.gov",
//                AssertionConsumerService = AssertionConsumerServiceExtensions.Post.Url("https://identityapi.doc.la.gov/saml2-signin", 0, true),
//                SingleLogoutServiceEndpoint = SingleLogoutServiceTypes.Post.Url("https://identityapi.doc.la.gov/signedout"),
//                AuthnRequestsSigned = true,
                
//                Signature = new X509Certificate2("C://Users/dinah/Desktop/IdentityAPI.doc.la.gov.pfx", "HondaS2000",  X509KeyStorageFlags.UserKeySet),
...
//                        EmailAddresses = new []{"james.alt@la.gov"},
//                        TelephoneNumbers = new []{ "225-219-7138" }
//                    }
//                },
...
//                {
//                    OrganizationDisplayName = new LocalizedName[] { new LocalizedName { Language = "en-US", Value = "Louisiana State Government" } },
//                    OrganizationName = new LocalizedName[] { new LocalizedName { Language = "en-US", Value = "Department of Corrections IdentityApi" } },
//                    OrganizationURL = new[] { new LocalizedUri { Language = "en-US", Uri = new Uri("https://identityAPI.doc.la.gov") } }
//                },
//                NameIdFormat = NameIdFormatTypes.Email,
//                //CacheDuration = "PT604800S",
//                //Id = $"_{Guid.NewGuid()}",
//                ServiceNames = new LocalizedName[] { new LocalizedName { Language = "en-US", Value = "identityAPI.doc.la.gov" } },
//                ServiceDescriptions = new LocalizedName[] { new LocalizedName { Language = "en-US", Value = "Department of Corrections Offender System" } },
