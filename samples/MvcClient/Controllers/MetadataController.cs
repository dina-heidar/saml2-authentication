    ...
    public class MetadataController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            var sp = new BasicSpMetadata
            {
                ...
                {
                    EncryptionCertificate = new X509Certificate2("C://Users/dinah/Desktop/prod.saml.ciprs.doc.la.gov.pfx", "HondaS2000", X509KeyStorageFlags.Exportable),
                ...
                SigningCertificate = new X509Certificate2("C://Users/dinah/Desktop/prod.saml.ciprs.doc.la.gov.pfx", "HondaS2000", X509KeyStorageFlags.Exportable),
                EntityID = "identityAPI.doc.la.gov",
                AssertionConsumerService = AssertionConsumerServiceExtensions.Post.Url("https://ciprs.doc.la.gov/saml2-signin", 0, true),
                SingleLogoutServiceEndpoint = SingleLogoutServiceTypes.Post.Url("https://ciprs.doc.la.gov/signedout"),
                AuthnRequestsSigned = true,
                
                Signature = new X509Certificate2("C://Users/dinah/Desktop/prod.saml.ciprs.doc.la.gov.pfx", "HondaS2000",  X509KeyStorageFlags.UserKeySet),
                ...
                Organization = new Organization
                {
                    ...
                    OrganizationName = new LocalizedName[] { new LocalizedName { Language = "en-US", Value = "Department of Corrections" } },
                    OrganizationURL = new[] { new LocalizedUri { Language = "en-US", Uri = new Uri("https://ciprs.doc.la.gov") } }
                },
                NameIdFormat = NameIdFormatTypes.Email,
                //CacheDuration = "PT604800S",
                //Id = $"_{Guid.NewGuid()}",
                ServiceNames = new LocalizedName[] { new LocalizedName { Language = "en-US", Value = "ciprs.doc.la.gov" } },
